...
const Sent = () => {
    ...
    useEffect(() => {
        let mails = [];
        fetch(`https://mail-box-72-default-rtdb.firebaseio.com/${username}/sent.json`).then((res) => {
            return res.json();
        }).then((data) => {
    ...
    const deleteHandler = (key) => {
        fetch(`https://mail-box-72-default-rtdb.firebaseio.com/${username}/sent/${key}.json`, {
            method: "DELETE",
        }).then((res) => {
